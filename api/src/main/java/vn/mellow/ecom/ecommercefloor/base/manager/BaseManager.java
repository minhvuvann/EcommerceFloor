...
public class BaseManager {
    ...
    protected List<ActivityLog> getActivityLogByRequestId(String partnerId, String requestId) {
        List<Bson> filter = new ArrayList<>();
        filter.add(Filters.eq("partnerId", partnerId));
    ...
    protected ActivityLog addActivityLog(String partnerId, ActivityUser user, String description, String requestId, ActivityLogType type, Class requestEntity) {
        ...
        activityLog.setPartnerId(partnerId);
    ...
    public String generateCode(String partnerId, Class entity) {
...
//        updateCreateDate.put("sequenceId",1000l);
    ...
    protected List<Bson> getFilters(String partnerId) {
        List<Bson> filter = new ArrayList<>();
    ...
    protected List<Bson> getFilters(String partnerId, BaseFilter baseFilter) {
        return baseFilter.getFilterList(partnerId);
    }
}
