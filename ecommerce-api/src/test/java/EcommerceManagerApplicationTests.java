...
//import vn.mellow.ecom.utils.GeoUtils;
...
//            {
//                productManager.updateVariantDisCount(productVariant.getId(), product.getDiscount());
//                productManager.updateVariantPrice(productVariant.getId(), product.getMediumPrice().getAmount());
//                productManager.updateVariantSalePrice(productVariant.getId(), product.getSalePrice().getAmount());
//            });
//        }
//    }
//
...
//        try {
//            deck_1 = productController.createIndustrialProduct(deck_1);
//            deck_2 = productController.createIndustrialProduct(deck_2);
//            deck_3 = productController.createIndustrialProduct(deck_3);
//            deck_4 = productController.createIndustrialProduct(deck_4);
//            deck_5 = productController.createIndustrialProduct(deck_5);
//            deck_6 = productController.createIndustrialProduct(deck_6);
//            deck_7 = productController.createIndustrialProduct(deck_7);
//            deck_8 = productController.createIndustrialProduct(deck_8);
//            deck_9 = productController.createIndustrialProduct(deck_9);
//            deck_10 = productController.createIndustrialProduct(deck_10);
//            deck_11 = productController.createIndustrialProduct(deck_11);
//            deck_12 = productController.createIndustrialProduct(deck_12);
//            deck_13 = productController.createIndustrialProduct(deck_13);
//
//
//        } catch (ServiceException e) {
//            e.printStackTrace();
