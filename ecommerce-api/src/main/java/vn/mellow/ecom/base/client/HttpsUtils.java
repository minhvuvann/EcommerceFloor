...
public class HttpsUtils {
    ...
    public static String getCasso(String url, String token) throws ClientException {
        return pushRequestCasso(url, null, "GET", null, token);
    }

    public static String postCasso(String url, String token,String body) throws ClientException {
        return pushRequestCasso(url, body, "POST", null, token);
    }
    ...
    private static String pushRequestCasso(String urlRest,String body, String method, String requestId, String token) throws ClientException {
