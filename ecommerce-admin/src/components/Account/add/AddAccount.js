...
import {getDistricts, getProvinces, getWards} from "../../../services/workspaces.sevices";
...
function AddAccount() {
    ...
    useEffect(() => {
        ...
        async function loadData() {
            ...
            const state = await getDistricts(provinceData?.data[0]?.ghn_id);
            ...
            <div className={cx("modal")}>
                <form className={cx("form")}>
                    ...
                    <div style={{width: "100%", display: "flex", justifyContent: "center"}}>
                        <button className={cx("purchase--btn")}>THÊM TÀI KHOẢN</button>
                    </div>
                </form>
            </div>
        </div>
